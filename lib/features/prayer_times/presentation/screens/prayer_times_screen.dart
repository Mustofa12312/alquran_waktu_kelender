  ...
  Widget _buildPrayerTimesList() {
    ...
    return prayerTimesAsync.when(
      data: (pt) {
        ...
        final prayerData = [
          _PrayerData('Subuh', DateFormat('HH:mm').format(pt.fajr),
              AppColors.fajr, Icons.nights_stay_rounded, Prayer.fajr),
          _PrayerData('Terbit', DateFormat('HH:mm').format(pt.sunrise),
              AppColors.sunrise, Icons.wb_twilight_rounded, Prayer.sunrise),
          _PrayerData('Dzuhur', DateFormat('HH:mm').format(pt.dhuhr),
              AppColors.dhuhr, Icons.wb_sunny_rounded, Prayer.dhuhr),
          _PrayerData('Ashar', DateFormat('HH:mm').format(pt.asr),
              AppColors.asr, Icons.cloud_rounded, Prayer.asr),
          _PrayerData('Maghrib', DateFormat('HH:mm').format(pt.maghrib),
              AppColors.maghrib, Icons.wb_twilight_outlined, Prayer.maghrib),
          _PrayerData('Isya', DateFormat('HH:mm').format(pt.isha),
              AppColors.isha, Icons.dark_mode_rounded, Prayer.isha),
        ];
        ...
        return Column(
          ...
          children: [
            ...
            ...prayerData
                .map((p) => _buildPrayerItem(p, p.type == pt.nextPrayer())),
          ],
        );
      },
